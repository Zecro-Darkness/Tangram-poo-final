...
void draw() {
  ...
  if (inicio == iniciar()) {
    ...
    fill(235, 183, 52);
    textSize(50);
    text("TANGRAM Programacion", 200, height/4);
...
void flecha(){
  ...
  flecha.vertex(0, 0);
  flecha.vertex(h1,0);
  flecha.vertex(h1-h2,-h2);
  flecha.vertex((h1-h2)+h2,-h2);
  flecha.vertex(h1+h2,0);
  flecha.vertex(h1+h2+h2,+h2);
  flecha.vertex(h1,h1+h2);
  flecha.vertex(h1-h2,h1+h2);
  flecha.vertex(h1,h1);
  flecha.vertex(0,h1);
  flecha.vertex(h2,h2);
  endShape(CLOSE);
